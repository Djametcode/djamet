...
const ContactCard = () => {
    ...
    const skill = ["HTML", "CSS", "javascript", "ReactJS", "Python", "Postman", "TailwindCSS", "HapiServer", "GIT", "Restfull API"]
    ...
    const Skills = ({data}) => {
        ...
        return (
            <ul className=" flex flex-row flex-wrap gap-2 w-full">
                {result}
            </ul>
        )
    }
    return (
        <div className=" flex flex-col gap-4 m-2">
            <div className=" flex justify-center flex-row">
                <div className=" bg-profile w-24 h-24 bg-cover rounded-full mt-5">

                </div>
            </div>
            <div className=" flex flex-col gap-2 text-white/50 font-jost">
            ...
            <div className=" bg-slate-600/30 p-4 w-full text-2xl text-center rounded-lg">
                <h1 className=" text-white/50 font-jost">Skills</h1>
            </div>
            <div>
                <Skills data = {skill}/>
            </div>
            <div className=" bg-slate-600/30 p-4 w-full text-2xl text-center rounded-lg">
                <h1 className=" text-white/50 font-jost">About Me</h1>
            </div>
            <div className=" bg-slate-600/30 p-2 rounded-lg h-56">
                <p>Hello My Name is Tofik Hidayat, I am Fullstack Developer, kindly visit project tab to see my project thanks!</p>
            </div>
        </div>
